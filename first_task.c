...
Note, that the program will print the output when you hit Enter after typing a line of text. This does not mean that scanf() is not reading the input by single characters. 
The line buffered input is the feature of the console window of the operating system and lets the user edit mistyped input before the program receives it.
